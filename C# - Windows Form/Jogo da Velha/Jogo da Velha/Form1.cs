...
namespace Jogo_da_Velha
{
    ...
    {
        int playerX = 0, playerO = 0, empatesPontos = 0, rodadas = 0;
        ...
        private void btm_Click(object sender, EventArgs e)
        {
            ...
            int buttonIndex = btn.TabIndex;//aqui esta referenciando o tabIndex do botão para usarmos no array
        ...
        void Vencedor(int playerGanhador)
        {
            ...
            {
                playerX++;
                xPontos.Text = Convert.ToString(playerX);
            ...
            {
                playerO++;
                oPontos.Text = Convert.ToString(playerO);
        ...
        {
            string suporte = "";//para chegar se é o jogaro x ou o;
            ...
            for (int horizontal = 0; horizontal < 8; horizontal += 3)
            {
                if (suporte == texto[horizontal])
                {
                    if (texto[horizontal] == texto[horizontal + 1] && texto[horizontal] == texto[horizontal + 2])
                    {
                        ...
                        return;//sai de dentro do método e sai do loop
                    }
                }
            }
            ...
            {
                empatesPontos++;
                lblEmpates.Text = Convert.ToString(empatesPontos);
